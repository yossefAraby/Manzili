...
import { isValidEmail, subscribeEmail } from "@/lib/services/localNewsletterService";
...
const Footer = () => {
    ...
    const socialIcons = [
        ...
        { icon: Presentation, label: "Overview Presentation", link: "https://drive.google.com/file/d/1vRGyjHcjuL59dHsidMS5nI5qH4pXrQsj/view?usp=sharing" },
        { icon: FileText, label: "Documentation", link: "https://drive.google.com/file/d/1uA7CCUhp35EooOkGJuAa-GyjQi9yYMN4/view?usp=sharing" },
    ]
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    ...
                    <div className="flex flex-wrap justify-between w-full md:w-[45%] gap-5 text-sm ">
                        ...
                        <form
                            ...
                            className="mt-3 flex bg-slate-100 text-sm p-1 rounded-full w-full border border-slate-200"
                        >
                            <input
                                suppressHydrationWarning
