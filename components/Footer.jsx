...
const Footer = () => {
    ...
    const MailIcon = () => (<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M14.6654 4.66699L8.67136 8.48499C8.46796 8.60313 8.23692 8.66536 8.00003 8.66536C7.76313 8.66536 7.5321 8.60313 7.3287 8.48499L1.33464 4.66699M2.66797 2.66699H13.3346C14.2502 2.66699 15 3.41699 15 4.33366V11.6663C15 12.5829 14.2502 13.333 13.3346 13.333H2.66797C1.75231 13.333 1.00264 12.5829 1.00264 11.6663V4.33366C1.00264 3.41699 1.75231 2.66699 2.66797 2.66699Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> </svg>);
    const PhoneIcon = () => (<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M9.22003 11.045C9.35772 11.1082 9.51283 11.1227 9.65983 11.086C9.80683 11.0493 9.93117 10.9654 10.0078 10.8474L11.8358 7.66007C11.9078 7.55271 11.9432 7.42537 11.9365 7.29803C11.9299 7.17069 11.8812 7.04936 11.7965 6.95403L10.6312 5.78936C10.5465 5.69403 10.4245 5.64536 10.3012 5.65336C10.1778 5.66136 10.0638 5.72336 9.99583 5.8207L8.16783 9.0087C8.09183 9.1187 7.96383 9.1827 7.83783 9.1787C7.71183 9.1747 7.58783 9.1027 7.52383 8.9887L5.10783 4.29469C5.03917 4.17536 4.92417 4.0947 4.79583 4.0907C4.6675 4.0867 4.54817 4.1607 4.48083 4.27669L2.64883 7.46136C2.56283 7.59136 2.54783 7.7567 2.61083 7.89403C2.67383 8.03136 2.81083 8.12203 2.96583 8.13069L9.22003 11.045Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/> </svg>);
    ...
    />
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © Manzili All Right Reserved.
                </p>
            </div>
        </footer>
    );
