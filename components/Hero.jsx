                ...
                <div className='relative flex-1 flex flex-col bg-[#2582eb]/10 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-[#2582eb]/10 text-[#2582eb] pr-4 p-1 rounded-full text-xs sm:text-sm'>
                            <span className='bg-[#2582eb] px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>NEWS</span> Free Shipping on Orders Above $50! <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                        </div>
                    ...
                    <Image className='sm:absolute bottom-0 right-0 md:right-10 w-full sm:max-w-sm' src={assets.hero_product_img2} alt="" suppressHydrationWarning />
                </div>
