...
export const dummyRatingsData = [
  {
    ...
    product: { name: "Wooden Key Holder", category: "Woodwork", id: "prod_1" },
  },
  {
    id: "rat_2",
    rating: 5.0,
...
export const dummyStoreData = {
  ...
  description:
    "Your destination for bespoke handcrafted jewelry, premium personalized stationery, and beautifully designed wooden home accessories.",
...
export const productDummyData = [
  {
    ...
    description:
      "Simple circular metal keychain with a polished finish and durable ring attachment. Lightweight and sturdy, suitable for everyday use or promotional purposes.",
    mrp: 375,
    price: 375,
    images: [product_img1],
    category: "Woodwork",
  ...
  },
  {
    ...
    description:
      "Polished round metal keychain with a smooth chrome finish. Lightweight, durable, and suitable for daily use or gifting.",
    mrp: 150,
    price: 150,
    images: [product_img2],
    storeId: "store_1",
  ...
  },
  {
    ...
    description:
      "Simple round metal keychain with glossy finish and strong ring attachment. Minimal design, ideal for accessories or promotional use.",
    mrp: 225,
    price: 225,
    images: [product_img3],
    storeId: "store_1",
  ...
  },
  {
    ...
    name: "Resin Ring",
    description:
      "Handcrafted ring made from natural wood combined with black epoxy resin. Features a smooth polished finish and unique organic pattern, giving it a modern and elegant handmade look.",
    mrp: 175,
    price: 175,
    images: [product_img4],
    storeId: "store_1",
  ...
  },
  {
    ...
    name: "Handmade Notebook",
    description:
      "A classic-style notebook with a durable natural leather cover and high-quality inner pages. Perfect for daily writing, note-taking, or sketching, and easy to carry for everyday use.",
    mrp: 200,
    price: 200,
    images: [product_img5],
    storeId: "store_1",
  ...
  },
  {
    ...
    name: "Decorated Journal",
    description:
      "A stylish lined journal page with decorative blue and green border design, clipped on a metal clipboard. Comes with markers, ideal for note-taking, journaling, or creative writing.",
    mrp: 250,
    price: 250,
    images: [product_img6],
    storeId: "store_1",
  ...
  },
  {
    ...
    description:
      "Golden brown homemade cookies just out of the oven with soft center and slightly crispy edges. Warm, fresh, and ideal as a dessert or snack.",
    mrp: 375,
    price: 375,
    images: [product_img7],
    storeId: "store_2",
  ...
  },
  {
    ...
    description:
      "Homemade pastries with different fillings, freshly baked with love and care. Perfect for breakfast or as a sweet treat.",
    mrp: 325,
    price: 325,
    images: [product_img8],
    storeId: "store_2",
  ...
  },
  {
    ...
    description:
      "Elegant wooden serving tray with a subtle natural fragrance, crafted from high-quality wood. Perfect for serving drinks or adding a natural touch to your home decor while providing a pleasant aroma.",
    mrp: 540,
    price: 540,
    images: [product_img9],
    storeId: "store_1",
  ...
  },
  {
    ...
    name: "Towels Sets",
    description:
      "Highly absorbent and ultra-soft towel sets, perfect for everyday use and a luxurious feel after every shower.",
    mrp: 500,
    price: 500,
  ...
  },
  {
    ...
    description:
      "Elegant and durable ceramic dinner sets, perfect for everyday dining and special occasions, combining style with long-lasting quality.",
    mrp: 1200,
    price: 1200,
  ...
  },
  {
    ...
    description:
      "Beautiful ceramic vases and decor pieces designed to enhance any space with a touch of artistic elegance and modern charm.",
    mrp: 480,
    price: 480,
...
export const couponDummyData = [
  {
    code: "NEW20",
    description: "20% off site-wide (admin global coupon)",
    discount: 20,
    scope: "GLOBAL",
    storeId: null,
    productIds: [],
  ...
  {
    code: "NOUR15",
    description: "15% off for all products in Nour store",
    discount: 15,
    scope: "STORE",
    storeId: "store_1",
    productIds: [],
  ...
  {
    code: "ARTSET10",
    description: "10% off selected handmade sets",
    discount: 10,
    scope: "PRODUCTS",
    storeId: "store_1",
    productIds: ["prod_1", "prod_3", "prod_5"],
    createdBy: "STORE",
  ...
  {
    code: "WELCOME10",
    description: "10% off site-wide (admin global coupon)",
    discount: 10,
    scope: "GLOBAL",
    storeId: null,
    productIds: [],
  ...
  {
    code: "TEEBA12",
    description: "12% off Teeba store products",
    discount: 12,
    scope: "STORE",
    storeId: "store_3",
    productIds: [],
  ...
  {
    code: "PORCELAIN8",
    description: "8% off selected porcelain products",
    discount: 8,
    scope: "PRODUCTS",
    storeId: "store_3",
    ...
    maxUsers: 75,
    usedCount: 10,
    createdAt: "2025-09-22T11:38:20.194Z",
  },
  {
    code: "ALL5",
    description: "5% off site-wide (admin global coupon)",
    discount: 5,
    scope: "GLOBAL",
    storeId: null,
    productIds: [],
...
export const storesDummyData = [
  ...
  },
  {
    ...
    name: "Tasty Home",
    description:
      "Comforting, homemade food, baked goods, and sweet snacks made with love.",
    username: "tastyhome",
  ...
  },
  {
    ...
    description:
      "Everything you need to elevate your space, from high-quality textiles and elegant porcelain dinnerware to rich, inviting fragrances.",
    username: "teebahome",
